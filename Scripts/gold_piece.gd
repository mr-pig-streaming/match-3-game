...
func _on_timer_timeout():
	...
	if (durability == 3):
		get_node("Sprite2D").texture = load("res://Art/Gold_cracked01.png")
	if (durability == 2):
		get_node("Sprite2D").texture = load("res://Art/Gold_cracked02.png")
	if (durability == 1):
		get_node("Sprite2D").texture = load("res://Art/Gold_cracked03.png")
...
func _on_harden_timer_timeout():
	if (durability > base_durability):
		...
		get_node("Shield").visible = false
	if (durability == 4):
		get_node("Sprite2D").texture = load("res://Art/Gold.png")
	if (durability == 3):
		get_node("Sprite2D").texture = load("res://Art/Gold_cracked01.png")
	if (durability == 2):
		get_node("Sprite2D").texture = load("res://Art/Gold_cracked02.png")
...
func clone():
	var copy = preload("res://Scenes/gold_piece.tscn").instantiate()
	copy.colour = colour
